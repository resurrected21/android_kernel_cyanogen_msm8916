...
# Export
export ARCH=arm
export CROSS_COMPILE=~/kernel/tc/bin/arm-eabi-
export KBUILD_BUILD_USER="res21"
export KBUILD_BUILD_USER="Proton-Plex"
...
function make_zip() {
mkdir -p tmp_mod
make modules_install INSTALL_MOD_PATH=tmp_mod INSTALL_MOD_STRIP=1
